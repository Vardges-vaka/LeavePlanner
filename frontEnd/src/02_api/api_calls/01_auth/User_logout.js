...
const displayName = AUTH_routes.User_logout.DISPLAY_NAME;
const isDebug = AUTH_routes.User_logout.isDebug;
const endpoint = AUTH_routes.User_logout.ENDPOINT;
const properties = AUTH_routes.User_logout.PROPERTIES;

const DEBUG = (data, operation) =>
  apiDebugger(displayName, isDebug, endpoint, data, operation);

const User_logout = async (payload, tCommon) => {
  DEBUG(null, "start");
  DEBUG("start_path");
