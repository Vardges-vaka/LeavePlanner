...
const displayName = AUTH_routes.User_logIn.DISPLAY_NAME;
const isDebug = AUTH_routes.User_logIn.isDebug;
const endpoint = AUTH_routes.User_logIn.ENDPOINT;
const properties = AUTH_routes.User_logIn.PROPERTIES;

const DEBUG = (data, operation) =>
  apiDebugger(displayName, isDebug, endpoint, data, operation);

const User_logIn = async (payload, tCommon) => {
  DEBUG(null, "start");
  DEBUG("start_path");
