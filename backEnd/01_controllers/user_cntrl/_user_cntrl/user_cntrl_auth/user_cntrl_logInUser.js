import { user_srv_logInUser } from "../../user_srv/_user_cntrl_srv.index.js";
import {
  consoleLog,
  debug_msg,
  validRespond_cntrl,
...
const displayName = "user_cntrl_logInUser.js";
const isDebug = true;
const service_Call = (req, res) => user_srv_logInUser(isDebug, req, res);
const DEBUG_LOG = (m, e) => consoleLog("cntrl", displayName, isDebug, m, e);

const user_cntrl_logInUser = async (req, res) => {
...
export default user_cntrl_logInUser;
